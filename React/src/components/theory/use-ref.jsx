...
// 리액트의 useRef는 컴포넌트 내에서 변하지 않는 값을 유지하거나 DOM 요소에 직접 접근할 때 사용하는 훅(Hook)입니다.
// 다른 리액트 Hook과 목적이 다릅니다.
...
// App 컴포넌트에서 등록 버튼을 눌렀을 때, 포커스 인풋 태그 쪽으로 넘어가도록 코드를 작성해 보도록 하겠습니다.
