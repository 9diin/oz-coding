...
// 각 페이지가 독립적으로 동작하기 때문에, 공통된 레이아웃이나 UI 코드를 반복해서 작성하는 경우가 많았습니다.
...
// 폼, 레이아웃, 페이지 등을 만들 수 있습니다. 쉽게 말해, 컴포넌트 + 컴포넌트 = 새로운 컴포넌트라고 이해하시면 됩니다.
...
// 위와 같은 문제 때문에, 중앙 집중식 상태 관리 라이브러리인 Redux, Redux Toolkit, Recoil, Zustand, Jotai 등이 탄생되었습니다.
// 공통적으로 사용되는 즉, 전역적으로 사용되는 상태(state), 액션(action)의 묶음을 관리하거나 혹은 개별적으로 관리할 수 있습니다.
